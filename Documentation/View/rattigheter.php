...
Namespace anges till <code>App\Model</code> och använd nyckelordet <code>use</code> för
att kunna använda ramverkets delar lätt.</p>
...
class Permission
{
    <span class="comment">// Lagra roller</span>
    private $group;
...
helhet som exempel i filen <code>Documentation/Model/Permission.php</code>.

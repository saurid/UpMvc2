...
befintliga mapparna <code>App/</code>, <code>Documentation/</code> och <code>vendor/</code>.
App är faktiskt en modul även den, men eftersom den är standardmodulen så har den ett litet annat
beteende, tex behöver du aldrig ange den i URL&apos;ens route. Den nya mappen/modulen
ska precis som app innehålla mapparna <code>Controller/,
...
sökvägar, tex <code>Up::view-&gt;render(&apos;Guestbook/View/Post.php&apos;);</code>.</p>
...
så genom att skriva <code>Documentation/</code> först så hämtas standardcontroller och action i
modulen <code>Documentationc</code>. Sökvägen till manualen är i en standardinstallation således:</p>

<p><code>http://localhost/UpMvc2/Documentation/Index</code></p>

<p>Eller utskrivet i sin helhet:</p>

<p><code>http://localhost/UpMvc2/Documentation/Index/index</code></p>

<p>Alltså modul: <code>Documentation</code>, controller: <code>Documentation\Controller\Index</code> och action: <code>index()</code></p>
...
$post = Up::view-&gt;render(&apos;Guestbook/View/Post.php&apos;);

<span class="comment">// Rendrera en mall från App</span>
$post = Up::view-&gt;render(&apos;App/View/Post.php&apos;);
</pre>
